...
if __name__ == "__main__":
    ...
    for node_pair, algs in data.items():
        for alg_name, alg_results in algs.items():
            ...
            proportions[node_pair][alg_name] = {
                ...
                "exploredN/pathN": alg_results["explored_n"] / alg_results["path_n"],
            }
    ...
    for node, algorithms in proportions.items():
        for algorithm, metrics in algorithms.items():
            ...
            algorithm_sums[algorithm]["exploredN/pathN"] += metrics["exploredN/pathN"]
    ...
    bar1 = ax.bar(methods, relative_path_costs, bar_width, label="Relative Path Cost")
